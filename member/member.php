    ...
    <div id="kode">
        ...
        if (isset($_POST['logout'])) {
            if (isset($_SESSION['role'])) {
                ...
                echo "<script>alert('Anda berhasil Keluar !');window.location.href='member';</script>";
            }
        }
        ?>
    </div>
                    ...
                    <div class="col">
                        <div class="box box-primary">
                            <div class="box-header pb-2">
                                ...
                                ?>
                                    <a href="tambah_member" class="btn btn-primary" role="button" title="Tambah Data"><i class="glyphicon glyphicon-plus"></i> Tambah Data</a>
                                <?php
                                }
                                ?>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                ?>
                                                    <td>
                                                        <a href="ubah_member?id=<?= $row['id']; ?>" class="btn btn-success" role="button" title="Ubah Data">Ubah Data<i class="glyphicon glyphicon-edit"></i></a>
                                                        <a href="hapus_member?id=<?= $row['id']; ?>" class="btn btn-danger" role="button" title="Hapus Data">Hapus Data<i class="glyphicon glyphicon-trash"></i></a>
                                                    </td>
                                                <?php
                                                }
                                                ?>
